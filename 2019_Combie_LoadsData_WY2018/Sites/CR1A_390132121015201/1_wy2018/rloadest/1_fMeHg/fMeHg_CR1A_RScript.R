#fMeHg CR1A script for retrieving loads models stats (the stats are used to select the best model for this constituent at this site) and loads predictions.
...
#print(fMeHg_CR1Am1,brief = FALSE, load.only = FALSE)
#print(fMeHg_CR1Am2,brief = FALSE, load.only = FALSE)
#print(fMeHg_CR1Am3,brief = FALSE, load.only = FALSE)
#print(fMeHg_CR1Am4,brief = FALSE, load.only = FALSE)
#print(fMeHg_CR1Am5,brief = FALSE, load.only = FALSE)
#print(fMeHg_CR1Am6,brief = FALSE, load.only = FALSE)
#print(fMeHg_CR1Am7,brief = FALSE, load.only = FALSE)
#print(fMeHg_CR1Am8,brief = FALSE, load.only = FALSE)
