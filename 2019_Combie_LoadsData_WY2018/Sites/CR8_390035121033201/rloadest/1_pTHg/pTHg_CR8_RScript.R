#pTHg CR8 script for retrieving loads models stats (the stats are used to select the best model for this constituent at this site) and loads predictions.
...
#print(pTHg_CR8m1,brief = FALSE, load.only = FALSE)
#print(pTHg_CR8m2,brief = FALSE, load.only = FALSE)
#print(pTHg_CR8m3,brief = FALSE, load.only = FALSE)
#print(pTHg_CR8m4,brief = FALSE, load.only = FALSE)
#print(pTHg_CR8m5,brief = FALSE, load.only = FALSE)
#print(pTHg_CR8m6,brief = FALSE, load.only = FALSE)
#print(pTHg_CR8m7,brief = FALSE, load.only = FALSE)
#print(pTHg_CR8m8,brief = FALSE, load.only = FALSE)
