#fTHg CR1D script for retrieving loads models stats (the stats are used to select the best model for this constituent at this site) and loads predictions.
...
#print(fTHg_CR1Dm1,brief = FALSE, load.only = FALSE)
#print(fTHg_CR1Dm2,brief = FALSE, load.only = FALSE)
#print(fTHg_CR1Dm3,brief = FALSE, load.only = FALSE)
#print(fTHg_CR1Dm4,brief = FALSE, load.only = FALSE)
#print(fTHg_CR1Dm5,brief = FALSE, load.only = FALSE)
#print(fTHg_CR1Dm6,brief = FALSE, load.only = FALSE)
#print(fTHg_CR1Dm7,brief = FALSE, load.only = FALSE)
#print(fTHg_CR1Dm8,brief = FALSE, load.only = FALSE)
#print(fTHg_CR1Dm9,brief = FALSE, load.only = FALSE)
#Commenting these out. These provide some explanations of the data in a longer form. Brief results are printed to console (fTHg_CR1Dm1-9)
